...
#
# Convert EH2 (VeeR) simulation log to the standard trace CSV format.
# Adapted from the ibex log-to-trace-CSV converter.
...
def convert_operands_to_abi(operand_str):
    ...
    Returns:
        A string of the operands for the instruction, with register names
        converted to ABI.
    """
