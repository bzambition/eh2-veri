...
本节补齐 IRQ agent 中此前只有逐段解释、没有 ``literalinclude`` 的四个源文件。
这些片段也把当前实现边界固定下来：IRQ agent 是 active stimulus agent，没有独立
monitor component。

.. literalinclude:: ../../../../dv/uvm/core_eh2/common/irq_agent/eh2_irq_agent_pkg.sv
   :language: systemverilog
   :lines: 1-15
   :linenos:
   :caption: dv/uvm/core_eh2/common/irq_agent/eh2_irq_agent_pkg.sv:L1-L15

逐段精读：L1-L6 建立 package 和 UVM 依赖；L8-L14 依次 include item、driver、
sequencer、sequence 和 agent。顺序体现 driver 依赖 seq item、agent 依赖 driver 与
sequencer。

.. literalinclude:: ../../../../dv/uvm/core_eh2/common/irq_agent/eh2_irq_agent.sv
   :language: systemverilog
   :lines: 1-35
   :linenos:
   :caption: dv/uvm/core_eh2/common/irq_agent/eh2_irq_agent.sv:L1-L35

逐段精读：L7-L14 声明 driver 和 sequencer 成员；L20-L27 只在 active 模式创建这两个
component；L29-L33 连接 ``seq_item_export``。源码没有 monitor 或 analysis port。

.. literalinclude:: ../../../../dv/uvm/core_eh2/common/irq_agent/eh2_irq_seq.sv
   :language: systemverilog
   :lines: 1-30
   :linenos:
   :caption: dv/uvm/core_eh2/common/irq_agent/eh2_irq_seq.sv:L1-L30

逐段精读：L5-L13 定义随机化字段；L16-L29 创建 ``eh2_irq_seq_item`` 并把 interrupt
level、source、duration 传给 driver。它是 test 层发起 IRQ 激励的最小 sequence。

.. literalinclude:: ../../../../dv/uvm/core_eh2/common/irq_agent/eh2_irq_sequencer.sv
   :language: systemverilog
   :lines: 1-12
   :linenos:
   :caption: dv/uvm/core_eh2/common/irq_agent/eh2_irq_sequencer.sv:L1-L12
